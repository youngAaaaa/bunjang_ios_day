...
public enum URLs {
    ...
    public static let updateProductURL = "/bungae/product/registration?productId="
    public static let detailProductURL = "/bungae/product/registration?productId="
    ...
    public static let detailStoreURL = "/bungae/stores/{:storeId}/detail"
    public static let updateStoreURL = "/bungae/stores/{:storeId}/detail"
    public static let homeURL = "/bungae/feed?p="
}
