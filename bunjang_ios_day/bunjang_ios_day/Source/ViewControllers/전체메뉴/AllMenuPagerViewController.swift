...
class AllMenuPagerViewController: TabmanViewController {
    ...
    private func configureView(){
        let categoriesVC = UIStoryboard.init(name: "AllMenus", bundle: nil).instantiateViewController(withIdentifier: "CategoriesViewController") as! CategoriesViewController
        let brandVC = UIStoryboard.init(name: "AllMenus", bundle: nil).instantiateViewController(withIdentifier: "BrandsViewController") as! BrandsViewController
        let serviceVC = UIStoryboard.init(name: "AllMenus", bundle: nil).instantiateViewController(withIdentifier: "ServiceViewController") as! ServiceViewController
